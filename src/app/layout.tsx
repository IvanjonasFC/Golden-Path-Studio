  ...
  return (
    <html lang="es" suppressHydrationWarning>
      ...
      <body>
        ...
        <nav id="main-nav" data-scrolled="false" className="sticky z-50 mx-auto flex w-full justify-center transition-all duration-300 data-[scrolled=false]:top-0 data-[scrolled=false]:max-w-full data-[scrolled=false]:px-0 data-[scrolled=true]:top-6 data-[scrolled=true]:max-w-[850px] data-[scrolled=true]:px-4">
          <div id="nav-inner" data-scrolled="false" className="flex w-full items-center justify-between transition-all duration-300 backdrop-blur-md data-[scrolled=false]:rounded-none data-[scrolled=false]:border-transparent data-[scrolled=false]:bg-transparent data-[scrolled=false]:px-8 data-[scrolled=false]:py-4 data-[scrolled=false]:shadow-none data-[scrolled=true]:rounded-full data-[scrolled=true]:border-white/10 data-[scrolled=true]:bg-[#050505]/95 data-[scrolled=true]:px-8 data-[scrolled=true]:py-3.5 data-[scrolled=true]:shadow-2xl">
